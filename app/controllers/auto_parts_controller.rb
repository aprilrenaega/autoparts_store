...
def by_make
    ...
    params[:vehicle_make].downcase!

  @auto_parts = AutoPart.where(vehicle_make: params[:vehicle_make]).order(:price)
  if params[:vehicle_model]
    params[:vehicle_model].downcase!
